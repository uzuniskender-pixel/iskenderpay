...
## Mevcut Durum (22 Mayıs 2026) — v8.22 / 20260522-08
...
js/ui.js            (henüz yok)
js/app.js           (henüz yok)
version.json        {"v": "8.22", "build": "20260522-08"}
...
|---|---|---|
| v8.22 | 20260522-08 | db.js import + var dönüşümü + window sync + Firebase guard |
